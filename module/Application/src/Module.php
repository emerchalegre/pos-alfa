...
class Module {
    ...
    public function mvcPreDispatch($event) {
        ...
        $auth = $event->getApplication()->getServiceManager()->get('Application\Service\LoginServiceInterface');
        
        if(!$auth->hasIdentity() && $controllerName != 'Application\Controller\LoginController') {
...
//        if ($controllerName ==
//                'Application\Controller\BeerController' && $actionName == 'delete') {
